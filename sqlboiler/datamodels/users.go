...
var UserWhere = struct {
	...
	DeletedAt: whereHelpertime_Time{field: "`users`.`deleted_at`"},
}
...
var (
	userAllColumns            = []string{"id", "company_id", "name", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"company_id", "name"}
...
func (q userQuery) One(exec boil.Executor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "datamodels: failed to execute a one query for users")
	}
...
func (q userQuery) All(exec boil.Executor) (UserSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "datamodels: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: failed to count users rows")
	}
...
func (q userQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "datamodels: failed to check if users exists")
	}
...
func FindUser(exec boil.Executor, iD int, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "datamodels: unable to select from users")
	}
...
func (o *User) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("datamodels: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "datamodels: unable to insert into users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "datamodels: unable to populate default values for users")
	}
...
func (o *User) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("datamodels: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("datamodels: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("datamodels: no users provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("datamodels: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "datamodels: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "datamodels: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("datamodels: no User provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("datamodels: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "datamodels: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "datamodels: unable to reload all in UserSlice")
	}
...
func UserExists(exec boil.Executor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "datamodels: unable to check if users exists")
	}
